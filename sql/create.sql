...
INSERT INTO `mock_config`(`id`, `uri`, `method`, `type`, `sync_response`, `async_response`, `async_call_path`, `async_method`, `delay_seconds`, `response_content_type`, `async_content_type`) VALUES (1, '/test', 'GET', 0, '{\"getResponse\": \"hello world\"}', NULL, NULL, NULL, NULL, 'application/json;charset=UTF-8', '');
INSERT INTO `mock_config`(`id`, `uri`, `method`, `type`, `sync_response`, `async_response`, `async_call_path`, `async_method`, `delay_seconds`, `response_content_type`, `async_content_type`) VALUES (2, '/test', 'POST', 1, '{\"postResponse\": \"hello world\"}', '{\"response\": \"hello world\"}', 'http://localhost:9099/test', 'GET', 10, 'application/json;charset=UTF-8', 'application/json;charset=UTF-8');
